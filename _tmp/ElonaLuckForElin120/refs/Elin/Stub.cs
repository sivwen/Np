...
public class Card{public CardBlueprint bp=new CardBlueprint();public SourceCard sourceCard=new SourceCard();public Category category=new Category();public Rarity rarity;public string id="";public virtual int Evalue(int id)=>0;}
...
public class Chara:Card{public bool IsPC=>true;public bool IsPCParty=>true;}
